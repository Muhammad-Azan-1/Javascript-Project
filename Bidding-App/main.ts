let diceBox = document.querySelector(".dice") as HTMLDivElement;
let diceAllFaces = document.querySelectorAll(".dice .face") as NodeListOf<HTMLDivElement>;
let diceBoxFace1 = document.querySelector("#face1") as HTMLDivElement;
let diceBoxFace2 = document.querySelector("#face2") as HTMLDivElement;
let diceBoxFace3 = document.querySelector("#face3") as HTMLDivElement;
let diceBoxFace4 = document.querySelector("#face4") as HTMLDivElement;
let diceBoxFace5 = document.querySelector("#face5") as HTMLDivElement;
let diceBoxFace6 = document.querySelector("#face6") as HTMLDivElement;
let btn = document.querySelector(".btn1") as HTMLButtonElement;
let btn2 = document.querySelector(".btn2") as HTMLButtonElement;

let ammountInput = document.querySelector(".bet-amoun") as HTMLInputElement;
let numberInput = document.querySelector(".bet-num") as HTMLInputElement;
console.log(ammountInput , numberInput , 'vals')


let userAmount = document.querySelector(".amount") as HTMLInputElement;
let userAmountBox = document.querySelector(".userAmountBox") as HTMLDivElement;

let warning = document.querySelector(".warning") as HTMLDivElement;
let enterAmountWarning = document.querySelector(".message") as HTMLParagraphElement;
let totalAmount = document.querySelector(".totalAmount") as HTMLParagraphElement;
...
function unHideDiceFace(compVal: number, userNum: number) {
...
function hideAll() {
diceAllFaces.forEach((items : HTMLDivElement)=>{
